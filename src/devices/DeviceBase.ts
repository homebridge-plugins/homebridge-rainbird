...
export abstract class DeviceBase {
  ...
  async getDeviceConfigSettings(accessory: PlatformAccessory, device: DevicesConfig): Promise<void> {
    const deviceConfig = {};
    const properties = [
      'logging', 'refreshRate', 'updateRate', 'pushRate', 'external', 'showRainSensor', 'showValveSensor', 'showProgramASwitch', 'showProgramBSwitch',
      'showProgramCSwitch', 'showProgramDSwitch', 'showDelayIrrigationSwitch', 'showStopIrrigationSwitch', 'minValueRemainingDuration',
      'maxValueRemainingDuration', 'syncTime', 'showRequestResponse', 'showZoneValve', 'includeZones', 'irrigationDelay',
    ];
